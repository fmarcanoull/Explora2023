...
$TOTAL_VOLS = 114; # EL B0 INICIAL CUENTA POR 3 TR  
$TOTAL_SECS_EXP = '$TOTAL_VOLS * $TR'; ### 58000 = 58 * TR		
$TIEMPO_T2 = '3 * $TR' ;  				# B0, IMAGEN INICIAL	
$TIEMPO_BO_2 = $TR ;  				   # B0, INTERCALADO, POS 26,57,82,113	
...
$DuracionFicheroINTRO		= 10042; 		# msg
...
TEMPLATE "ExploraDWI.tem" {
   ...
   $BEEP2F					$BEEP2B 						$BEEP2 						$LapsoBEEP;	
   $BEEPF					$BEEPB 						$BEEP 						$LapsoBEEP2_B0_2;		
   $BEEP2F					$BEEP2B 						$BEEP2 						$LapsoBEEP;	
   $BEEPF					$BEEPB 						$BEEP 						$LapsoBEEP2;
   $BEEP2F					$BEEP2B 						$BEEP2 						$LapsoBEEP;	
   $BEEPF					$BEEPB 						$BEEP 						$LapsoBEEP2;
   $BEEPF					$BEEPB 						$BEEP 						$LapsoBEEP_B0_2;	
   $BEEP2F					$BEEP2B 						$BEEP2 						$LapsoBEEP;	
   $BEEPF					$BEEPB 						$BEEP 						$LapsoBEEP2;	
   $BEEP2F					$BEEP2B 						$BEEP2 						$LapsoBEEP;	
   $BEEPF					$BEEPB 						$BEEP 						$LapsoBEEP2_B0_2;	
